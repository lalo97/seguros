...
<body class="paginas-internas">
    <section class="bienvenidos" id="encabezado">
        ...
        <div class="texto-encabezado text-center">
            ...
            <div class="container">
                <h1 class="display-4 wow bounceIn">GMM</h1>
                <p class="wow bounceIn" data-wow-delay=".3s">Seguros de Gastos Medicos Mayores</p>
       ...
       <div class="container">
           ...
           <div class="row">
               <div class="col-12 text-right">
                   ...
                   <a href="profile.php">Inicio</a> » GMM
                ...
                <table class="table table-bordered wow zoomIn" data-wow-duration=".6s" data-wow-delay=".3s">
                  ...
                  <tbody>
                   <?php
                        ...
                        $query = "SELECT pol.id, emp.firstName, pago.paymentType, seguro.secureType, banco.bankName, pol.cost, pol.paymentDate FROM poliza pol INNER JOIN empleado emp on pol.employeesId = emp.id INNER JOIN pago on pol.paymentId = pago.id INNER JOIN seguro on pol.insuranceId = seguro.id INNER JOIN banco on pol.bankId = banco.id WHERE seguro.secureType='GMM'";
                        ...
                        if(mysqli_num_rows($res) > 0) {
                            ...
                            echo ('<tr><th scope="row" colspan="8">0 Results</th></tr>');
                        }
                        mysqli_close($conn);
                    ?>
