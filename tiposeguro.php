...
<body class="paginas-internas">
    <section class="bienvenidos" id="encabezado">
        ...
        <div class="texto-encabezado text-center">
            ...
            <div class="container">
                <h1 class="display-4 wow bounceIn">Tipo de Seguros</h1>
            </div>
    ...
    <script>
       ...
       $.getJSON("https://aseguradora.000webhostapp.com/index.php/tiposeguro")
           .done(function(datos_ws){
            $.each(datos_ws, function(indice, valor){
                    $("#tabla-empleado").append('<tr><th scope="row">'
                + valor.id +'</th><td>'+valor.nombre_tipoSeguro+'</td></tr>');
            })
       });
    });
